...
public class ProductService {
	...
	public Product getProductById(UUID productId) {
		...
		if (product != null) {
			...
			String baseUrl = "https://wms-backend-mizve.ondigitalocean.app"; // URL backend hoặc service hosting ảnh
	...
	public Page<ProductResponse> getProducts(Pageable pageable, String searchTerm, UUID categoryId, String sortDir) {
	    String baseUrl = "https://wms-backend-mizve.ondigitalocean.app";
